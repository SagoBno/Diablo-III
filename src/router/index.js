...
const routes = routerOptions.map((r) => ({
  ...r,
  /*
    This is the way to make a lazy load, it works to load only the part of the component that is
    going to be displayed, it helps to optimize the loading times of the page
  */
